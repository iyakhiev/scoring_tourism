...
<div class="navbar bg-base-100 px-10 relative justify-center shrink-0 h-36 md:h-20 md:px-24">
	<div class="flex flex-col md:flex-row items-center justify-evenly md:justify-between h-full w-full max-w-7xl mx-auto z-10">
		<a href="/projects" class="font-medium text-xl px-5">
